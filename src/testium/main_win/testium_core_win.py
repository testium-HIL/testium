...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        icon5 = QIcon()
        icon5.addFile(u":/black/about.png", QSize(), QIcon.Mode.Normal, QIcon.State.Off)
        self.actionAbout_testium.setIcon(icon5)
        self.actionExit = QAction(MainWindow)
        self.actionExit.setObjectName(u"actionExit")
        icon6 = QIcon()
        icon6.addFile(u":/black/exit.png", QSize(), QIcon.Mode.Normal, QIcon.State.Off)
        ...
        icon10 = QIcon()
        icon10.addFile(u":/black/settings.png", QSize(), QIcon.Mode.Normal, QIcon.State.Off)
